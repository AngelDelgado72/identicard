                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex space-x-2">
                                            ...
                                            <!-- Eliminar o "Tu cuenta" -->
                                            @if($usuario->id !== auth()->id())
                                                <form method="POST" action="{{ route('admin.usuarios.destroy', $usuario->id) }}" 
                                                      onsubmit="return confirm('¿Está seguro de eliminar este usuario?')" class="inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" 
                                                            class="text-white p-2 rounded transition hover:opacity-80"
                                            ...
                                            @else
                                                <span class="text-gray-400 text-xs px-2 py-1">Tu cuenta</span>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
